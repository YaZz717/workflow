...
-- CreateEnum
CREATE TYPE "OrgRole" AS ENUM ('OWNER', 'ADMIN', 'MANAGER', 'MEMBER', 'GUEST');
...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('TASK_ASSIGNED', 'TASK_COMMENTED', 'TASK_DUE_SOON', 'MENTION', 'PROJECT_ADDED', 'INVITATION', 'ROLE_CHANGED', 'COMMENT_REPLY');
...
-- CreateEnum
CREATE TYPE "CalendarEventType" AS ENUM ('MEETING', 'DEADLINE', 'EVENT', 'REMINDER');
...
CREATE TABLE "OrganizationSettings" (
    ...
    "defaultProjectRole" "ProjectRole" NOT NULL DEFAULT 'MEMBER',
    "weekStartsOn" INTEGER NOT NULL DEFAULT 1,
    "maxUploadMb" INTEGER NOT NULL DEFAULT 10,
    "publicProjectsEnabled" BOOLEAN NOT NULL DEFAULT false,
    "updatedAt" TIMESTAMP(3) NOT NULL,
